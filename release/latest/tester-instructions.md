...
For the campaign map toolbar, popup and selection-inspector redesign slice, use:

```powershell
npm run test:browser -- --grep "campaign-map-toolbar-uses-migrated-mode-action-groups|campaign-map-popups-use-migrated-shared-frame|campaign-map-selection-inspector|visual-safety-captures-core-surfaces"
