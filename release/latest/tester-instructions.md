...
For the campaign map toolbar, popup, selection-inspector and layer/object dock redesign slice, use:

```powershell
npm run test:browser -- --grep "campaign-map-toolbar-uses-migrated-mode-action-groups|campaign-map-popups-use-migrated-shared-frame|campaign-map-selection-inspector|campaign-map-layer-dock|visual-safety-captures-core-surfaces"
