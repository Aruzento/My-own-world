...
- Restore preview, partial restore, grouped asset/link/orphan diagnostics, backup-gated selected repair and edit-session conflict protection are implemented for the current safety scope. The active roadmap risk is finalizing the structured NF-002 roll result contract and later dice policies before rolls/feeders become durable session data.
