...
- The `0.0.1.8` redesign pass is accepted by the owner for the current stage. Final visual polish remains future debt; the active project phase is `0.0.1.10.0` repository cleanup in `docs/01-delivery/PROJECT_PLAN.md`, one owner-approved RCB leaf at a time.
