...
- `npm run test:browser -- tests/browser/world-package.spec.mjs` passed locally for the `0.0.1.8.14.5` World Package manager, including Tools entry, branch export, library refresh, default conflict blocking, copy-mode conflict import, parent rewiring, page-only import after backup, sanitized imported HTML and layout guards.
