...
?????? desktop-???????? ?????? ? `docs/DESKTOP_PROTOTYPE_SMOKE.md`.

### Storage / backup / assets

????????, backup ? assets ?????????? ?????????? ?? adapter boundary:

- `StorageAdapter` ???????? ?? workspace, ??????/?????? ??????, ??????/?????? ???????? ?????? ? ???????? ??????????.
- `AssetAdapter` ???????? ?? ?????? ??????, ????????? URL ??????????? ? ???????? ??????? assets.
- `backupService` ?????? ????????? ???????? ? assets ????? `StorageAdapter`, ????? browser ? desktop ???????????? ???? ????????.
