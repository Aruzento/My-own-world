...
- `creature` - КЗ, хиты, временные хиты, скорость, базовые характеристики, чувства и особенности;
...
- `character` - уровень, КЗ, хиты, временные хиты, скорость, базовые характеристики и хиты от смерти.
...
Базовые токены подключены через `styles/design-tokens.css`. Полный редизайн не выполнялся: токены добавлены как безопасная foundation-основа для будущих UI-этапов.
