...
Следующий рабочий пункт: **5. Popup Lifecycle Standardization**.

Пункты 3 и 4 закрыты базово. Дальше логично стабилизировать popup lifecycle, потому что новые будущие системы карты, свойств, графов и desktop UI будут создавать еще больше popup/dialog сценариев.
