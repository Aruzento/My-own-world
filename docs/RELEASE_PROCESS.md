...
5. Обновить `CHANGELOG.md`: перенести `Unreleased` в новую версию.
...
rg -n $pattern .github js tests docs README.md CHANGELOG.md --glob "!docs/MY_OWN_WORLD_FULL_MANUAL.docx"
```
...
3. `CHANGELOG.md` должен иметь раздел `vX.Y.Z - YYYY-MM-DD`.
