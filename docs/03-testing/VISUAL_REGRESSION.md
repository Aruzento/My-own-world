...
- campaign map рендерит scene inspector, layer/object dock, selection dock, токены, объект, фигуру, сетку и locked fog zone;
...
4. Проверить карту мастера: scene inspector, сетка, туман, locked fog zone, токены, фигуры, слои и контекстные меню.
