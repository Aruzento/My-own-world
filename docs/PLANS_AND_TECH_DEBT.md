...
Следующий рекомендуемый пункт: **22. Campaign Map UX-Доработки**.

Причина: пункты 17-20 закрыты. Пункт 21 уже был выполнен раньше как CSS Separation. Следующий первый несделанный крупный пункт - UX-доработки карты: mass select, открыть изображение, hidden hero icon, square fog brush и locked fog zones.
