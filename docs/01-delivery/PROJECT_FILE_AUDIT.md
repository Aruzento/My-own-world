...
|---|---:|---|
| `docs/MY_OWN_WORLD_FULL_MANUAL.docx` | 5796408 | Проверить актуальность и место хранения; бинарные документы тяжелее навигации по markdown. |
...
| `docs/01-delivery/WORK_LOG.md` | 623315 | Да: держать metadata, актуальность и кодировку под контролем. |
