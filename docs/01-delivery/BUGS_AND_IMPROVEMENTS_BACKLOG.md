...
| BI-015 | P2 | Knowledge graph / undo | Done | `0.0.1.5.4.2` | Closed in `0.0.1.5.4.2`: the graph toolbar now has visible Back/Forward history controls, and Ctrl+Z / Ctrl+Y handle node moves, saved position reset and manual relationship creation while the graph canvas has focus. |
