...
Статус: **сделано MVP**. Поля `Свойств` получили runtime drag handle для перестановки и настройку ширины `1x/2x` в popup шестеренки. Полная resize-сетка остается будущим расширением.
