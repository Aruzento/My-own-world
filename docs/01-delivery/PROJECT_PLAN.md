...
Current leaf: `0.0.1.16.9` Combat UI + Reload Workflow is `DONE` at automated/Foundation readiness. `0.0.1.16.10` Persistence / Recovery / Event Integration is `NEXT`, on `HOLD` until owner manual UI acceptance of 16.9; not started.
...
9. `0.0.1.16.10` Persistence / Recovery / Event Integration - `NEXT`, `HOLD` pending owner manual UI acceptance of 16.9; not started.
