...
| CTV Stage 3 — `Variable Store и Variables / Entity API` | `NEXT` — separate task required | variablesJson codec; Variable Store; Variables / Entity API; PageRecord persistence/write boundaries; computed resolver foundation. |
