...
Current leaf: `0.0.1.16.9.2` Prepare Next Combat Flow is `DONE` automated, awaiting owner manual acceptance. `0.0.1.16.9.1` remains automated `DONE`. `0.0.1.16.9` remains `DONE` automated/Foundation, but its owner manual acceptance `FAILED` with a realistic roster. `0.0.1.16.10` Persistence / Recovery / Event Integration is `NEXT`, on `HOLD` until owner acceptance of the corrected UI and preparation flow; not started. AI Core remains `LATER`.

Important stop note: `RCB-021`, `RCB-001`, `RCB-001B`, `RCB-002`, `RCB-003`, `RCB-022`, `RCB-004`, `RCB-005`, `RCB-016`, `RCB-023`, `RCB-024`, `RCB-025`, `RCB-006A`, `RCB-006B`, `RCB-006C`, `RCB-006D`, `RCB-007A`, `RCB-007B`, `RCB-007C`, `RCB-007D`, `RCB-026`, `RCB-027`, `RCB-017`, `RCB-018`, `RCB-019`, `RCB-028`, `RCB-008`, `RCB-009`, `RCB-010`, `RCB-020`, `RCB-011`, `RCB-012`, `RCB-013`, `RCB-014`, `RCB-015`, `RCB-029` and `RCB-030` are closed. `RCB-006`, `RCB-007`, `0.0.1.10.0`, `0.0.1.11.0`, `0.0.1.12.0`, `0.0.1.13.5`, `0.0.1.13.6`, `0.0.1.13.7`, `0.0.1.13.8`, `0.0.1.13.9`, `0.0.1.13.10`, `0.0.1.13.FINAL`, `0.0.1.13.0`, `0.0.1.14.2`, `0.0.1.14.3`, `0.0.1.14.4`, `0.0.1.14.5`, `0.0.1.14.6`, `0.0.1.14.7`, `0.0.1.14.8`, `0.0.1.14.9`, `0.0.1.14.10`, `0.0.1.14.FINAL`, `0.0.1.14.0`, `0.0.1.15.1`, `0.0.1.15.2`, `0.0.1.15.3`, `0.0.1.15.4`, `0.0.1.15.5`, `0.0.1.15.6`, `0.0.1.15.7`, `0.0.1.15.8`, `0.0.1.15.9`, `0.0.1.15.10`, `0.0.1.15.11`, `0.0.1.15.FINAL` and `0.0.1.15.0` are closed. `0.0.1.16.0` is `ACTIVE`; `0.0.1.16.1`, `0.0.1.16.2`, `0.0.1.16.3`, `0.0.1.16.4`, `0.0.1.16.5`, `0.0.1.16.6`, `0.0.1.16.7`, `0.0.1.16.8` and `0.0.1.16.9` are `DONE` at automated/Foundation level; `0.0.1.16.10` is `NEXT` on `HOLD` until owner manual UI acceptance of 16.9. Do not implement later Combat Session leaves, attacks, damage application, HP automation, effects, targeting or dice UI out of order.
...
8. `0.0.1.16.9` Combat UI + Reload Workflow - `DONE` at automated/`Foundation` readiness on 2026-09-10. Existing Initiative popup now derives pre-combat/active/paused/finished UI from canonical state, with explicit Start, Store-owned progression/lifecycle/markers, active-only roster reconciliation and read-only integrity warnings. Active/paused/finished serialize/reload, pending-input rejection safety, one successful action/one save and zero rejected/no-op saves are covered. No second Combat surface/state owner, persistent format change, repair, EventStore or later combat mechanics. Owner manual UI acceptance is required before starting 16.10; this is not a release-ready claim.
   Corrective `0.0.1.16.9.1` Combat UI Usability Fix - `DONE` automated on 2026-09-11, awaiting owner manual retest. Owner manual acceptance of 16.9 FAILED: long names/controls collided in compressed rows and lifecycle actions were hard to reach. Order cards now separate identity/current badge, initiative cluster, flags and warnings; names wrap without truncation. The existing popup is 500px where space permits, with one viewport-bounded roster scroll area and non-scrolling header/navigation/actions. Shared positioning applies existing size constraints before measuring; Initiative geometry does not animate. Eight named participants plus one unresolved Combat-only member cover geometry, keyboard, footer reachability and active/paused evidence at 1280x900, 480x720 and 1024x768. Domain/save/schema behavior is unchanged. This does not pass owner manual acceptance.
   Corrective `0.0.1.16.9.2` Prepare Next Combat Flow - `DONE` automated on 2026-09-11, awaiting owner manual acceptance. Finished popup offers `Подготовить новый бой`: pure lifecycle `finished -> null`, existing Store setter publishes once, initiative stays intact and the existing picker opens. Roster/value edits and Roll use existing initiative owners; Apply leaves no session, explicit Start creates a fresh id, round 1 and false Ready/Delayed markers. Preparation survives save/reload; failure remains a dirty save error. No schema, persistent preparation flag, new owner, EventStore or 16.10 work; corrected 16.9.1 layout remains covered.
9. `0.0.1.16.10` Persistence / Recovery / Event Integration - `NEXT`, `HOLD` pending owner manual acceptance after 16.9.1/16.9.2; not started.
