...
0.0.0.1.14. Добавить Rule Tree provider для автоматических эффектов.

Зачем: после появления `Rule Tree` выбранные правила должны отдавать эффекты в тот же pipeline, что предметы, заклинания и навыки.
