...
Будущие owners, в существующих зонах кода:
...
Contract операций (имена будущие, зависимости обязательны):
