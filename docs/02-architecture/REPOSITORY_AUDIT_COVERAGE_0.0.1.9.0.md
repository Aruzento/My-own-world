...
| `tools/run_browser_smoke.mjs`, desktop gate/clickthrough tools | Browser/desktop gates | Smoke and release gates | REVIEWED - FINDING | Main | N/A | Writes reports | High | Desktop/browser smoke | RA-003, RA-004 | Error status risk confirmed. |
