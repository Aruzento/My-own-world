...
| `tests/browser/knowledge-graph`, popup, property, tables specs | Browser tests | Graph/popup/properties/tables | REVIEWED - PARTIAL FINDING CLOSED | Main | N/A | N/A | High | 26 specs reviewed | RA-017, RA-018, RA-019 | RA-017 is closed by `RCB-017`; RA-018 and RA-019 remain open accessibility/overlay findings. |
