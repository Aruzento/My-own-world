...
| `js/taskTracker/taskTrackerDnd.js`, page actions | Task Tracker interaction | DnD and page action writes | REVIEWED - PARTIAL FINDING CLOSED | Main, reviewer 3 | Tracker runtime | Direct page action write | High | Task tracker tests | RA-006, RA-028 | Keyboard reorder is closed by `RCB-028`; remaining write-boundary debt stays under split `RCB-006`. |
