...
| `styles/design-tokens.css`, `variables.css`, base/layout/ui CSS | Base CSS/tokens | Shared design system | REVIEWED - PARTIAL FINDING CLOSED | Main, reviewer 3 | N/A | N/A | Medium | UI polish audit | RA-020, RA-030 | `RCB-020` added Settings and Character Sheet semantic tokens; remaining token/layer debt stays under RA-030. |
...
| `styles/app-topbar.css`, settings CSS | Settings/topbar CSS | Settings and top shell styles | REVIEWED - PARTIAL FINDING CLOSED | Main, reviewer 3 | N/A | N/A | Medium | UI polish audit | RA-020, RA-030 | Settings `--mow-line-height-normal` and `--mow-input-color` are closed by `RCB-020`; broader token/layer cleanup remains under RA-030. |
