...
| `styles/world-package.css` | 793 | World Package manager popup for export, saved package library, JSON import preview, backup/apply states, conflict-mode controls and `0.0.1.8.14.5` data-safety markers. |
...
styles/world-package.css       World Package manager popup; `0.0.1.8.14.5` scopes branch/world export, package library, JSON import preview, conflict-mode controls and backup-gated page-only import
```
