...
| `styles/world-package.css` | 479 | World Package manager popup for export, saved package library, JSON import preview, backup/apply states and `0.0.1.8.14.4` data-safety markers. |
...
styles/world-package.css       World Package manager popup; `0.0.1.8.14.4` scopes branch/world export, package library, JSON import preview and backup-gated page-only import
```
