...
- App settings/tools popovers and component catalogue popover remain the current shared primitive/overlay reference; the Settings maintenance popup now has its own migrated `0.0.1.8.14.2` baseline and should not regress to unmarked ad hoc sections.
