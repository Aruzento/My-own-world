...
| Campaign map and live scene | `.campaign-map-document`, `.campaign-map-stage`, `.campaign-map-controls[data-map-ui-migration="0.0.1.8.12.1"]`, `.campaign-map-control-group[data-map-control-group]`, `#campaignMapPopup[data-map-popup-ui-migration="0.0.1.8.12.2"]`, `.campaign-map-popup-shell[data-map-popup-ui-migration="0.0.1.8.12.2"]`, `.campaign-map-popup-section[data-map-popup-section]`, `.campaign-map-selection-dock[data-map-selection-ui-migration="0.0.1.8.12.3"]`, `.campaign-map-layer-dock[data-map-layer-dock-ui-migration="0.0.1.8.12.4"]`, tokens, shapes, fog canvas | `styles/design-tokens.css` owns `--mow-map-*`; `styles/campaign-map-layout.css`, `styles/campaign-map-responsive.css`, `styles/campaign-map-popups.css`, `styles/campaign-map-selection-inspector.css`, `styles/campaign-map-layer-dock.css`, `styles/campaign-map-initiative.css` consume it | Toolbar, popup headers, selection dock and layer/object dock use local sprite icons through `iconSvg` for add, character, creature, object, pan, grid, map image, layers, shapes, drawing, fog, presentation, initiative, music, visibility, duplicate, more and remove actions; do not add external icon packs | Generic `#campaignMapPopup` popups register as modal dialog overlays through `campaignMapPopupController` and now share the migrated map popup frame; `#campaignTokenPopup` registers as a non-modal popover and keeps delayed hover behavior local; the selection dock and layer/object dock are runtime stage surfaces, not persisted overlays | Foundry scenes, Roll20 lighting, Owlbear scene/fog clarity. |
