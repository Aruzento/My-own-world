...
- current design status: `0.0.1.8.16` Visual regression for design system is closed at `Foundation`; [UI_MIGRATION_BASELINES.md](./UI_MIGRATION_BASELINES.md) is the comparison manifest for future UI migration patches. Pause for owner review before leaving the design track.
