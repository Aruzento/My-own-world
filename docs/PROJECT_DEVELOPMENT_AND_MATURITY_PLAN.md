...
2.2. Добавить ручную команду `Создать резервную копию workspace`: **не сделано**.
...
2.4. Добавить restore flow: **частично сделано**. Добавлен осторожный restore helper, который восстанавливает страницы из snapshot без удаления новых файлов.
