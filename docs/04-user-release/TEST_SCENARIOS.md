...
5. На карте проверить scene inspector, layer/object dock и selection dock: слева сверху должно быть видно состояние фона, сетки и тумана с быстрыми действиями в существующие настройки, справа сверху dock должен показывать количество токенов, объектов, фигур и скрытых объектов, а при выделении нескольких токенов/фигур нижний dock должен показывать сколько из них видно/скрыто и давать групповые `Скрыть` / `Показать`.
