...
5. На карте проверить scene inspector и layer/object dock: слева сверху должно быть видно состояние фона, сетки и тумана с быстрыми действиями в существующие настройки, а справа сверху dock должен показывать количество токенов, объектов, фигур и скрытых объектов; переключение видимости слоя должно сразу менять карту.
