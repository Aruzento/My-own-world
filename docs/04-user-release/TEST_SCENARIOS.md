...
5. На карте проверить layer/object dock: он должен показывать количество токенов, объектов, фигур и скрытых объектов, а переключение видимости слоя должно сразу менять карту.
