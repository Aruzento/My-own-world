...
- Knowledge Graph is usable as a visual canvas workbench with selected-node edge states, a laconic inspector/overlay layer and split CSS ownership, but richer day-to-day relationship operations, remaining JavaScript split, lifecycle hardening and concept rethink remain backlog work.
