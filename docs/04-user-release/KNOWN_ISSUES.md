...
- Knowledge Graph is usable as a visual canvas workbench with selected-node edge states and an inspector, but richer day-to-day relationship operations, file split, lifecycle hardening and final overlay polish remain backlog work.
