---
summary: "Historical feature-specific tester instructions"
read_when:
  - "When investigating the dated implementation evidence extracted from tester-instructions.md"
owner_zone: "archive"
---

# Historical feature-specific tester instructions

Historical snapshot extracted from source HEAD `650507d2458c5a205cd34a6d555f296c56c3c9d9` on 2026-09-15. Current owner: [tester-instructions.md](../../../release/latest/tester-instructions.md). Statements such as current, next, future and passed below describe their original dates; they are not current implementation instructions or release approval.
