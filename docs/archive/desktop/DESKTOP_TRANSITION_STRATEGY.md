---
summary: "Historical desktop foundation evidence: DESKTOP_TRANSITION_STRATEGY.md; current boundaries live in DESKTOP_ADAPTER_PLAN.md."
read_when:
