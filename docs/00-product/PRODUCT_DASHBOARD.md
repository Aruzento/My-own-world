...
3. `RCB-021` pending autosave loss, `RCB-001` page rollback/repository consistency, `RCB-001B` metadata index consistency and `RCB-002` durable tree batch rollback are closed. Next recommendation is `RCB-003`, then `RCB-022` and `RCB-004`.
...
- Choose the next `0.0.1.10.0` RCB leaf. Recommended next leaf: `RCB-003`.
