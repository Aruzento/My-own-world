...
- Continue `0.0.1.8.13` Migration Phase 7 knowledge graph with the remaining canvas renderer/actions/overlay JavaScript split and lifecycle bridge work from `BI-017` / `BI-018`. Do not start `0.0.1.8.14` secondary screens yet.
