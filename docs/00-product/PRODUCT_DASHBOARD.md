...
- Continue `0.0.1.8.12` Migration Phase 6 campaign map with deeper layer/token dock polish, map inspector surfaces and advanced contextual actions. Toolbar, popup and selected-object dock foundations are closed; do not repaint them again unless a concrete bug appears.
