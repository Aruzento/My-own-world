...
- Continue with `0.0.1.8.15` Migration Phase 9 polish and cleanup: accessibility audit, performance pass, visual regression review, theme preset review, animation review, dead CSS cleanup and documentation sync. Do not add new visible Knowledge Graph features until `BI-026` rethinks the graph concept.
