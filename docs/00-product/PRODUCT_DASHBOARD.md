...
- Continue `0.0.1.8.12` Migration Phase 6 campaign map with map inspector surfaces and advanced contextual actions. Toolbar, popup, selected-object dock and layer/object dock slices are closed; do not repaint them again unless a concrete bug appears.
