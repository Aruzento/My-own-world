...
- Asset UI для broken/orphan assets уже есть; следующий риск - нет удобного repair-screen с переходом к странице-владельцу и массовым восстановлением путей.
