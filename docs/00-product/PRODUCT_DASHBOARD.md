...
- Assign CTV Stage 2 separately using the [canonical migration design](../02-architecture/CARD_TYPES_VARIABLES_MIGRATION.md) and the nine-stage order in [PROJECT_PLAN](../01-delivery/PROJECT_PLAN.md). After CTV Stage 9 closure and 17.6 parity, resume Phase 17 at 17.7. No Stage 2 implementation is included in Stage 1.
