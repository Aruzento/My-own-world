...
6. Next leaf: `0.0.1.12.7` Broken Link Diagnostics.
...
- Start `0.0.1.12.7` Broken Link Diagnostics when ready. Do not start `0.0.1.13.0` until Data Safety Completion is closed.
