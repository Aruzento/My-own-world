...
5. `0.0.1.11.11` `BUG-009` Legacy Task Tracker Compatibility is `FIXED`; next leaf: `0.0.1.11.12` Shape Usability Decision.
...
- Continue `0.0.1.11.0` one leaf at a time. Next leaf: `0.0.1.11.12` Shape Usability Decision.
