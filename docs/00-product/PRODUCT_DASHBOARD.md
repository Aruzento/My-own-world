...
5. `0.0.1.11.4` `BUG-001` Large Workspace UX is `VERIFIED ACCEPTABLE`; next leaf: `0.0.1.11.5` Desktop Real-App Pass.
...
- Continue `0.0.1.11.0` one leaf at a time. Next leaf: `0.0.1.11.5` Desktop Real-App Pass.
