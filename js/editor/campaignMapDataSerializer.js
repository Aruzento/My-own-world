...
function serializeStageAttributes(
  ...
  const attributes = {
    ...
    'data-brush-shape': data.fog.brushShape,
    'data-fog-locked-zones': encodeURIComponent(
      JSON.stringify(
  ...
  return `
                <button
                  ...
                  ${serializeAttributes({
                    ...
                    'data-hp': token.hp,
                    'data-hp-max': token.hpMax,
                    'data-hp-temp': token.hpTemp,
                    'data-hp-percent': token.hpPercent,
                    'data-hp-state': token.hpState,
                    'data-armor-class': token.armorClass,
                    'data-speed': token.speed,
                    'data-initiative-modifier': token.initiativeModifier,
                    'data-condition-count': token.conditionCount,
                    'data-effect-count': token.effectCount,
                    'data-effects-summary': token.effectsSummary,
                    'data-incapacitated': token.incapacitated ? 'true' : '',
                    'data-speed-zero': token.speedZero ? 'true' : '',
